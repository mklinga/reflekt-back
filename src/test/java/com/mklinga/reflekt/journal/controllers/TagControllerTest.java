...
class TagControllerTest {
  ...
  public class GetAllTagsTest {
    ...
    @Test
    void getAllTagsRedirectsToLoginWithoutUser() throws Exception {
    ...
    List<Tag> getMockTagList() {
      ...
      tag1.setOwner(ApplicationTestConfiguration.testUser());
      tag1.setColor("#ff9900");
      tag1.setName("TAG 1");

      Tag tag2 = new Tag();
      tag2.setId(UUID.fromString("19ce638b-411e-4d3a-b2f9-0bdcd6f3d61c"));
      tag2.setOwner(ApplicationTestConfiguration.testUser());
    ...
    public void getAllTagsReturnsCorrectlyFormattedList() throws Exception {
      ...
      mockMvc.perform(MockMvcRequestBuilders.get("/tags/"))
          .andExpectAll(
              status().isOk(),
              content().json("[{\"id\":\"e18154be-765f-4b27-a6dc-a8d90cf6b3df\",\"name\":\"TAG 1\",\"color\":\"#ff9900\"},{\"id\":\"19ce638b-411e-4d3a-b2f9-0bdcd6f3d61c\",\"name\":\"TAG 2\",\"color\":\"#000001\"}]")
              );
    }
  }
}